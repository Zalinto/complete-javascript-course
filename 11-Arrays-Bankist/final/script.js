...
// console.log(dogs.some(dog => dog.curFood > dog.recFood * .9 && dog.curFood < dog.recFood * 1.1));

// console.log(dogs.filter(dog => dog.curFood > dog.recFood * .9 && dog.curFood < dog.recFood * 1.1));
